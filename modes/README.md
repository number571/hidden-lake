...
1. Classic: [config](classic), [example](../examples/echo_service/modes/classic)
2. Adaptive: [config](adaptive), [example](../examples/echo_service/modes/adaptive)
3. Multiplicative: [config](multiplicative), [example](../examples/echo_service/modes/multiplicative)
