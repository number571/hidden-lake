...
> More example images about HLF pages in the [github.com/number571/hidden-lake/cmd/applications/filesharer/images](https://github.com/number571/go-peer/tree/master/cmd/applications/filesharer/images "Path to HLF images")
