...
" > ~/.config/systemd/user/hidden-lake-adapter.http.service
...
systemctl --user enable hidden-lake-adapter.http.service
systemctl --user restart hidden-lake-adapter.http.service
