...
import (
	...
	"github.com/number571/hidden-lake/cmd/adapters"
	"github.com/number571/hidden-lake/cmd/adapters/common/internal/config"
	"github.com/number571/hidden-lake/cmd/adapters/common/internal/consumer/internal/adapted"
	"github.com/number571/hidden-lake/cmd/adapters/common/pkg/settings"
	hlt_client "github.com/number571/hidden-lake/cmd/helpers/traffic/pkg/client"
	"github.com/number571/hidden-lake/internal/logger/std"
)
