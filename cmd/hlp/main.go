...
import (
	...
	"github.com/number571/hidden-lake/internal/applications/pinger/pkg/app"
	"github.com/number571/hidden-lake/internal/applications/pinger/pkg/settings"
...
func main() {
	...
	if gFlags.Get("-h").GetBoolValue(args) {
		help.Println(settings.GetServiceName(), settings.CServiceDescription, gFlags)
		return
	}
