...
__Step 1__. Run HLH=composite (composite of HL services). 
...
__Step 2__. After launching the HLH=composite application, a private key will be generated by HLK that reflects your identity on the Hidden Lake network. In order to start communicating with a friend, you must exchange public keys with them. 
