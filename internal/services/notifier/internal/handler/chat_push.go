...
import (
	...
	hls_settings "github.com/number571/hidden-lake/internal/services/notifier/pkg/settings"
	...
	"github.com/number571/hidden-lake/pkg/api/services/notifier/request"
)
