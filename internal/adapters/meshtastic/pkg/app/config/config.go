...
type SConfigSettings struct {
	...
	FMaxDelayTimeMS   uint64 `json:"max_delay_time_ms,omitempty" yaml:"max_delay_time_ms,omitempty"`
...
type SConnection struct {
	FDevPath string `json:"devpath,omitempty" yaml:"devpath,omitempty"`
	FChannel uint8  `json:"channel,omitempty" yaml:"channel,omitempty"`
}
...
type SConfig struct {
	...
	FConnection *SConnection     `yaml:"connection,omitempty"`
}
...
func (p *SConnection) GetDevPath() string {
	return p.FDevPath
}

func (p *SConnection) GetChannel() uint8 {
	return p.FChannel
}
...
func (p *SConfigSettings) GetMaxDelayTime() time.Duration {
	return time.Duration(p.FMaxDelayTimeMS) * time.Millisecond // nolint: gosec
}
