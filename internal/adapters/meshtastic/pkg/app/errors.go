...
const (
	errPrefix = "internal/adapters/meshtastic/pkg/app = "
)
...
var (
	...
	ErrGetCertificate = &SError{"get certificate"}
	ErrGetCertPool    = &SError{"get cert pool"}
	ErrAddCertToPool  = &SError{"add cert to pool"}
