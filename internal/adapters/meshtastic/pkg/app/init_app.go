...
func InitApp(pArgs []string, pFlags flag.IFlags) (types.IRunner, error) {
	...
	cfgPath := filepath.Join(inputPath, hla_meshtastic_settings.CPathYML)
	...
	build.LogLoadedBuildFiles(hla_meshtastic_settings.GetAppShortNameFMT(), stdfLogger, okLoaded)
