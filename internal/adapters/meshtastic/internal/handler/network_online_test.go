...
import (
	...
	hla_http "github.com/number571/hidden-lake/pkg/network/adapters/meshtastic"
)
...
func (p *tsHTTPAdapter) WithLogger(string, logger.ILogger) hla_http.IMeshtasticAdapter {
	return p
}
