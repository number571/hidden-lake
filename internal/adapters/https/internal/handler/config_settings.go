...
import (
	...
	pkg_settings "github.com/number571/hidden-lake/internal/adapters/https/pkg/settings"
...
func HandleConfigSettingsAPI(
	...
	return func(pW http.ResponseWriter, pR *http.Request) {
		...
		_ = api.Response(pW, http.StatusOK, hla_https_config.GetConfigSettings(pConfig))
	}
}
