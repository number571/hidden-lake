...
func HandleConfigConnectsAPI(
	...
	return func(pW http.ResponseWriter, pR *http.Request) {
		logBuilder := http_logger.NewLogBuilder(hla_settings.GetFmtAppName().Short(), pR)
		...
		case http.MethodPost:
			...
			_ = pNetworkNode.AddConnection(pCtx, u.Host) // connection may be refused (closed)
		...
		case http.MethodDelete:
			...
			_ = pNetworkNode.DelConnection(u.Host) // connection may be refused (closed)
