...
import (
	...
	hla_http_client "github.com/number571/hidden-lake/internal/adapters/http/pkg/client"
...
func (p *tsTCPAdapter) WithLogger(_ string, _ logger.ILogger) tcp.ITCPAdapter {
	return p
}
