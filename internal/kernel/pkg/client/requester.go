...
func (p *sRequester) GetFriends(pCtx context.Context) (map[string]asymmetric.IPubKey, error) {
	...
	var vFriends []hlk_settings.SFriend
...
func (p *sRequester) AddFriend(pCtx context.Context, pFriend *hlk_settings.SFriend) error {
	_, err := api.Request(
		pCtx,
		p.fClient,
		http.MethodPost,
...
func (p *sRequester) DelFriend(pCtx context.Context, pFriend *hlk_settings.SFriend) error {
	_, err := api.Request(
		pCtx,
		p.fClient,
		http.MethodDelete,
